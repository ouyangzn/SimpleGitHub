...
import com.huidr.lib.pickview.listener.OnDismissListener;
import com.huidr.lib.pickview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
  ...
  protected void initViews() {
    ...
    if (context instanceof Activity) {
      ...
      throw new UnsupportedOperationException("context must be activity");
    }
    decorView = (ViewGroup) ((Activity) context).getWindow()
        .getDecorView()
        .findViewById(android.R.id.content);
